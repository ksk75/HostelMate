<%-- HostelMate — 404 Error Page --%>
<%@ page contentType="text/html;charset=UTF-8" language="java" isErrorPage="true" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Page Not Found — HostelMate</title>
...
<div class="auth-page">
    <div class="auth-container" style="text-align:center">
        <div class="auth-card">
            <div style="font-size:80px;color:var(--primary-400);margin-bottom:16px">
                <i class="bi bi-emoji-frown"></i>
            </div>
            <h1 style="font-size:48px;font-weight:900;color:var(--text-primary);margin-bottom:8px">404</h1>
